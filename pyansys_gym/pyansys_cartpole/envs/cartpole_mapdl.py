...
class CartPoleMapdl:
    ...
    def _build_cart_pilot_node(self):
        ...
        mapdl.n(self._nodes["cart_pilot"], 0.0, 0.0, 0.0)  # create a cart with only UX dof free.
    ...
    def _build_cylindrical_gap(self):
        ...
        mapdl.rmodif(self._ids["gap"], 12, 0.0)  # real constant 12: CV1 (damping coefficient)
