...
class CartPoleMapdlSimple:
    ...
    def __init__(self, **kwargs):
        ...
        self._pole = Pole(
            self._preferences.get("pole_radius", 0.01),
            self._preferences.get("pole_length", 1.0),
        )
        ...
        self._cart_mass = self._preferences.get("cart_mass", 1.0)

        self._max_time_points = self._preferences.get("max_time_points", 200)
        self._D_time = self._preferences.get("D_time", 0.02)
        self._d_time = self._preferences.get("d_time", 0.02)
        ...
        self._force_mag = self._preferences.get("force_mag", 10.0)
        self._force_dir = 1.0
